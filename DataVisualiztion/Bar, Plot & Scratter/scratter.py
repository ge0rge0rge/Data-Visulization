...
plt.scatter(x,stre,c='green',marker='o',label='Streptomycin')

plt.scatter(x,pen,c='red',marker='o',label='Penicilin')
# plt.scatter(x,stre,c='green',marker='o',label='Streptomycin')

plt.scatter(x,neo,c='blue',marker='o',label='Neomycin')
